...
*/
// combined, minifed form of jquery.cycle.lite.dev.js (Copyright (c) 2008-2012 M. Alsup, MIT/GPL) and total-slider-template.dev.js
...
var roll=(opts.nextSlide+1)==els.length;opts.nextSlide=roll?0:opts.nextSlide+1;opts.currSlide=roll?els.length-1:opts.nextSlide-1;}else{queueNext();}
