...
$('#edit-controls-saving').show().fadeTo(400,1);$('#edit-controls-save,#edit-controls-cancel').prop('disabled','disabled');if($('.total-slider-template-draggable').length<1||$('.total-slider-template-draggable-parent').length<1)
